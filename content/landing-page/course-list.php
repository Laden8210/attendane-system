...
?>
<section class="w-screen h-screen flex flex-col items-center justify-center bg-gradient-to-r from-violet-500 to-violet-950 p-5">
    <!-- Note: Heading -->
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-screen-lg">
        ...
        ?>
            <a style="background-color: <?php echo $bgColor; ?>;" href="index.php?view=login&course_id=<?php echo $courseId; ?>"
            
               class="shadow-lg border border-gray-200 rounded-lg h-80 w-64 p-4  hover:transform hover:scale-105 transition-transform duration-300 flex flex-col items-center justify-between">
                <!-- Department Logo -->
    
                <!-- Department Image -->
                <div class="card-header w-full mb-2">
                    <img src="<?php echo $courseImage; ?>" alt="course" class="w-full h-32 object-cover rounded-md">
                </div>
                <!-- Department Title -->
