        ...
        <div class="bg-slate-50 w-full  rounded-lg overflow-x-hidden overflow-y-auto ">
            ...
            <div class=" bg-slate-100 rounded ">
                ...
                <div class="p-2 rounded-lg ">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2" id="course-list">
        ...
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" id="courseForm">
                    ...
                    <div>
                        <label for="edit-color" class="block mb-2 text-sm font-medium text-gray-900">Course Color</label>
                        <input type="color" name="course_color" id="color" class="w-full h-10 rounded-lg border border-gray-300 p-1 focus:ring-blue-500 focus:border-blue-500" />
                    </div>
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow">
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                ...
                <button type="button" class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="edit-course-modal">
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                    </svg>
                    <span class="sr-only">Close modal</span>
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" id="editCourseForm">
                    ...
                    <div>
                        <label for="edit-color" class="block mb-2 text-sm font-medium text-gray-900">Course Color</label>
                        <input type="color" name="course_color" id="edit-color" class="w-full h-10 rounded-lg border border-gray-300 p-1 focus:ring-blue-500 focus:border-blue-500" />
                    </div>
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            Swal.fire({
                                ...
                                icon: 'error',
                                customClass: {
                                    confirmButton: 'bg-red-600 text-white px-5 py-2.5 rounded-lg'
                                },
